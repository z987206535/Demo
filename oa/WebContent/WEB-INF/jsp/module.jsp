...
<center>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            <a href="javascript:;" id="addPerson">添加模块</a>
          </TD>
          </TR>
          <TR>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6"  id="tab">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      ...
		      <td width="25%" height="37" align="center"><B>名称</B></td>
              <td width="35%" height="37" align="center"><b>url</b></td>
              <td width="30%" height="37" align="center"><b>操作</b></td>
          </tr>
          <!-- 列表数据栏 -->

          <%
          List<Module> rows = (List)request.getAttribute("rows");
          ...
          <tr  class="TableBody1">
              ...
              <td align="center" vAlign="center"><%=o.getUrl() %></td>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
         ...
         %>
         <a href="module?pageNo=<%=pageNo-1%>">上一页</a>
         <%} %>
         ...
         <%
           ...
           if(pageNo == i){
         %>
         <a  style="color:red" href="module?pageNo=<%=i%>"><%=i %></a>&nbsp;
         <%}else{%>
           <a href="module?pageNo=<%=i %>"><%=i %></a>&nbsp;
         <%
           }  
         }
         %>
         <%if(pageNo == page1){
          ...
          <a href="module?pageNo=<%=pageNo+1%>">下一页</a>
         <%} %>
         <a href="module?pageNo=<%=page1 %>">最后一页</a>
    		</TD>
          </TR>
        </TBODY>
      </TABLE>
