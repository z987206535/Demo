...
<center>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            <a href="javascript:;" id="addPerson">添加角色</a>
          </TD>
          </TR>
          <TR>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6"  id="tab">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      ...
		      <td width="55%" height="37" align="center"><B>角色名称</B></td>
              <td width="35%" height="37" align="center"><b>操作</b></td>
          </tr>
          <!-- 列表数据栏 -->

          <%
          List<Role> rows = (List)request.getAttribute("rows");
          ...
          <tr  class="TableBody1">
              ...
              <td align="center" vAlign="center">
                <a  href="javascript:void(0)" class="delRole">删除角色</a>
                <a  href="javascript:void(0)" class="aclRole" id="<%=o.getId() %>_<%=o.getName()%>">角色授权</a>
              </td>
          </tr>
         <% }%>
        <!-- 在列表数据为空的时候，要显示的提示信息 -->
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
         ...
         %>
         <a href="role?pageNo=<%=pageNo-1%>">上一页</a>
         <%} %>
         ...
         <%
           ...
           if(pageNo == i){
         %>
         <a  style="color:red" href="role?pageNo=<%=i%>"><%=i %></a>&nbsp;
         <%}else{%>
           <a href="role?pageNo=<%=i %>"><%=i %></a>&nbsp;
         <%
           }  
         }
         %>
         <%if(pageNo == page1){
          ...
          <a href="role?pageNo=<%=pageNo+1%>">下一页</a>
         <%} %>
         <a href="role?pageNo=<%=page1 %>">最后一页</a>
    		</TD>
          </TR>
        </TBODY>
      </TABLE>
...
<div id="orgList">
  <table>
     <tr><td></td><td>给[<span id="roleName"></span>]授权</td><td><a href="javascript:;" id="closewin">关闭窗口</a></td></tr>
     <tr>
       <td>模块编号</td>
       <td>模块名称</td>
       <td>权限</td>
     ...
     <%
       List<Module> mrows = (List)request.getAttribute("mrows");
       for(int i=0;i<mrows.size();i++){
    	   Module m = mrows.get(i);
     %>
     <tr>
       <td></td>
       <td><%=m.getName() %></td>
       <td>
       <input type="checkbox"  id="rid_<%=m.getId() %>_C" />C
       <input type="checkbox"  id="rid_<%=m.getId() %>_R" />R
       <input type="checkbox"  id="rid_<%=m.getId() %>_U" />U
       <input type="checkbox"  id="rid_<%=m.getId() %>_D" />D
       </td>
     </tr> 
     <%
       }
...
<script type="text/javascript" src="scripts/role.js">
</script>
